import { 
    ...
    ADD_NEW_SECTION, MOVE_SECTION, REMOVE_SECTION, UPDATE_SECTION, 
    SET_FIELD_VALUE, UPDATE_TEMPLATE, UPDATE_FIELD, FILTER_FIELDS, TOGGLE_FIELD_SELECTION, 
    BUTTON_CLASS, 
...
////////////////  
            case INITIALIZE: 
                ...
                if (!!template.Field_JSON__c){
                    layout = JSON.parse(template.Field_JSON__c)
                ...
                return { ...state, template: template, layout: layout, allFields: allFields };
////////////////    
...
// don't mess with the export syntax
export default data;